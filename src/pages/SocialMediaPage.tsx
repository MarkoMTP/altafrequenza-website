  ...
  return (
    <>
      <Helmet>
        {/* Primary Meta Tags */}
        <title>
          Social Media for Wedding Planners | Elegant Presence™ by Alta
          Frequenza Marketing
        </title>
        <meta
          name="description"
          content="Elegant Presence™ is a done-for-you social media management system for luxury wedding planners. Transform your Instagram into a refined, high-converting portfolio that attracts elite couples effortlessly."
        />

        {/* Keywords */}
        <meta
          name="keywords"
          content="social media for wedding planners, wedding planner marketing, Instagram management for wedding planners, luxury wedding marketing, social media agency for wedding planners"
        />

        {/* Open Graph / Facebook */}
        <meta
          property="og:title"
          content="Elegant Presence™ — Social Media for Luxury Wedding Planners"
        />
        <meta
          property="og:description"
          content="We help luxury wedding planners build an elegant, consistent online presence that attracts high-end couples and builds trust through beautiful storytelling."
        />
        <meta
          property="og:image"
          content="https://altafrequenzamarketing.com/elegant-presence.jpg"
        />
        <meta
          property="og:url"
          content="https://altafrequenzamarketing.com/social-media"
        />
        ...
        <meta
          ...
          content="Alta Frequenza Marketing helps wedding planners attract high-end couples with our Elegant Presence™ social media system."
        />
        <meta
          name="twitter:image"
          content="https://altafrequenzamarketing.com/og/elegant-presence.jpg"
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href="https://altafrequenzamarketing.com/social-media"
        />
      </Helmet>
        ...
        <section className="py-24 px-6 lg:px-12 bg-neutral-50">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed mb-16">
              ...
              doesn’t communicate elegance, precision, and consistency — you
              lose them instantly.
            </p>
        ...
        <section className="py-24 px-6 lg:px-12">
          <div className="max-w-6xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
              We take over your entire social presence — from strategy to
              content, posting, and engagement. You focus on weddings. We handle
              the visibility.
            </p>
          </div>
        ...
        <section className="py-24 px-6 lg:px-12 bg-neutral-900 text-white">
          <div className="max-w-6xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-neutral-300 max-w-3xl mx-auto leading-relaxed">
              Boost your reach, grow your following, and stay visible to the
              right couples — even when you’re not posting. Our Meta Growth
              System uses Instagram and Facebook Ads to consistently expand your
              audience and convert visibility into real inquiries.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto text-left">
            <div>
              ...
              <p className="text-lg text-neutral-300 leading-relaxed mb-6">
                With a refined ad strategy tailored to your brand, we use Meta
                Ads to amplify your best posts, reach thousands of luxury
                couples each month, and ensure your business stays top-of-mind.
              </p>
