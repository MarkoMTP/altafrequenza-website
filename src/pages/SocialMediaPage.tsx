    ...
    <div className="bg-white pt-20">
      <section className="min-h-[70vh] flex items-center justify-center px-6 lg:px-12 py-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 leading-relaxed max-w-3xl mx-auto mb-12">
            Sophisticated social media management that showcases your portfolio
            and attracts discerning couples. We craft content that reflects the
            elegance and exclusivity of your brand.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-serif text-neutral-900 mb-6">
              Your Instagram Should Reflect
              <br />
              Your Luxury Brand Standards
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
              High-net-worth couples research wedding planners extensively on
              social media. If your feed doesn't exude sophistication and
              expertise, you're losing clients before they even contact you.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Sporadic content creates the impression of an inactive or
                unprofessional business. Luxury clients expect consistency.
              </p>
            </div>
            ...
            <div className="bg-white p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Stock photos and templated captions don't showcase your unique
                style or the caliber of weddings you create.
              </p>
            </div>
            ...
            <div className="bg-white p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Without strategic storytelling, your social media becomes a
                disjointed collection of posts rather than a compelling brand
                narrative.
              </p>
            </div>
            ...
            <div className="bg-white p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Beautiful photos alone aren't enough. You need strategic
                engagement tactics to build relationships with luxury audiences.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                  We create Instagram feeds that look like they belong in Vogue.
                  Every post is carefully curated to showcase your work with the
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-neutral-700">
                      Professional photo selection and editing guidance
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Cohesive aesthetic that reflects luxury positioning
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Strategic showcase of high-end weddings and details
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
              ...
              <div className="bg-neutral-50 p-6 border border-neutral-200">
                <div className="grid grid-cols-3 gap-2 mb-4">
                  ...
                  <div className="aspect-square bg-neutral-200">
                    <img
                      src="https://images.pexels.com/photos/265667/pexels-photo-265667.jpeg?auto=compress&cs=tinysrgb&w=400"
                      alt="Wedding"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="aspect-square bg-neutral-200">
                    <img
                      src="https://images.pexels.com/photos/2072179/pexels-photo-2072179.jpeg?auto=compress&cs=tinysrgb&w=400"
                      alt="Wedding"
                      className="w-full h-full object-cover"
                    />
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                <div className="bg-white border border-neutral-200 p-6">
                  ...
                  <p className="text-sm text-neutral-800">
                    <span className="font-medium">YourPlanningCo</span> When
                    Sarah & James envisioned their Napa Valley celebration,
                    every detail whispered elegance. From the hand-calligraphed
                    invitations to the garden ceremony beneath centuries-old
                    oaks, this was a wedding that honored both tradition and
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                  We craft captions that do more than describe photos—they tell
                  the story of your expertise, your process, and the
                  unforgettable experiences you create for couples.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Sophisticated copy that resonates with affluent audiences
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Strategic hashtags to reach luxury wedding audiences
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Calls-to-action that drive consultation bookings
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                  We manage your entire content calendar, ensuring consistent
                  presence on Instagram and Pinterest—the two platforms where
                  luxury couples spend the most time during wedding planning.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      4-5 Instagram posts per week with Stories and Reels
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Pinterest boards optimized for luxury wedding searches
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Strategic posting times for maximum reach
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-neutral-700">
                      Monthly content calendar with advance planning
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 pb-4 border-b border-neutral-700">
                    <div className="text-center flex-shrink-0">
                      <div className="text-amber-600 font-serif text-2xl">
                        Mon
                      </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="text-sm text-amber-600 mb-1">
                        Instagram Post + Pinterest
                      </div>
                      <div className="text-neutral-300 text-sm">
                        Expert tip for couples
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Complete Instagram strategy, content creation, posting, Stories,
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Board creation, pin design, and optimization for luxury wedding
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Professional copywriting, caption crafting, and hashtag strategy
                for every post.
              </p>
            </div>
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Monthly planning with strategic posting schedule aligned to your
                business goals.
              </p>
            </div>
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Active engagement with followers, luxury wedding community, and
                potential clients.
              </p>
            </div>
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Detailed analytics on growth, engagement, reach, and lead
      ...
      <section className="py-24 px-6 lg:px-12 bg-amber-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-serif text-neutral-900 mb-6">
            Let Your Social Media Reflect
            <br />
            Your Luxury Brand
          </h2>
          <p className="text-lg text-neutral-700 mb-10 leading-relaxed">
            Stop struggling with inconsistent content and let our team showcase
            your work with the sophistication it deserves. Attract the high-end
            clientele you're meant to serve.
          </p>
          <Link
            to={"/contact"}
            className="inline-flex items-center gap-3 px-10 py-5 bg-neutral-900 text-white text-lg tracking-wide hover:bg-neutral-800 transition-all"
