      ...
      <section className="min-h-[70vh] flex items-center justify-center px-6 lg:px-12 py-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 leading-relaxed max-w-3xl mx-auto mb-12">
            A 24/7 intelligent chatbot that answers frequently asked questions,
            guides couples through your services, and ensures no inquiry goes
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 bg-amber-600 text-white rounded-2xl rounded-tl-none p-4">
                    <p className="text-sm">
                      Absolutely! We specialize in destination weddings and have
                      coordinated celebrations in Italy, France, Mexico, and
                      throughout the Caribbean. We handle all logistics, vendor
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 bg-amber-600 text-white rounded-2xl rounded-tl-none p-4">
                    <p className="text-sm">
                      Our full-service planning includes venue selection, vendor
                      curation, budget management, design & styling, timeline
                      creation, day-of coordination, and unlimited
                      consultations. We're with you from engagement to send-off!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-neutral-700 leading-relaxed">
                ...
                <p>
                  ...
                  services, pricing, availability, and process. It's like having
                  a knowledgeable assistant available 24/7.
                </p>
                <p>
                  By providing immediate value and guidance, the Assistant keeps
                  couples engaged, builds trust, and dramatically increases the
                  likelihood they'll book a consultation with you.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                ...
                elegant, unobtrusive, and on-brand—no generic chatbot look here.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                ...
                more losing high-quality leads simply because you were asleep or
                busy.
              </p>
            </div>
