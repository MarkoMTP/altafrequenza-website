        ...
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="space-y-3 mb-8 ml-6">
            <li className="text-lg text-neutral-700">
              <strong>Lost opportunities:</strong> Couples visit your website at
              midnight or on weekends. If they don't get immediate responses,
            ...
            <li className="text-lg text-neutral-700">
              ...
              consultations—time that could be spent on actual wedding planning.
            </li>
          </ul>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            ...
            information. It automatically assigns quality scores based on budget
            indicators, timeline, and level of engagement. You instantly know
            which inquiries are serious, high-budget couples versus casual
            browsers.
          </p>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            ...
            refining your service offerings, networking with luxury vendors, or
            actually planning weddings.
          </p>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            When you know a lead's budget, timeline, and priorities before your
            first conversation, consultations become dramatically more
            effective. You're not wasting time on couples who can't afford your
            services or aren't ready to commit.
          </p>

          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            Wedding planners using AI automation report conversion rates 2-3x
            higher than traditional inquiry forms, specifically because they're
            only speaking with pre-qualified, serious couples.
          </p>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            ...
            immediately apparent to luxury couples—and often the deciding factor
            in who they hire.
          </p>
          ...
          <div className="bg-amber-50 border-l-4 border-amber-600 p-8 my-12">
            ...
            <p className="text-lg text-neutral-800 leading-relaxed">
              ...
              automation one of the highest-leverage investments you can make in
              your business.
            </p>
          </div>
          ...
          <div className="mt-16 pt-12 border-t border-neutral-200">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-8">
              Our AI Concierge Suite includes both lead capture and FAQ chatbot
              functionality, specifically designed for luxury wedding planners.
