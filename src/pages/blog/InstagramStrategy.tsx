      ...
      <article className="max-w-4xl mx-auto px-6 lg:px-12 py-24">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-xl text-neutral-700 leading-relaxed mb-8">
            ...
            platform researching wedding inspiration, and your profile could be
            the deciding factor in whether they reach out.
          </p>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            Your Instagram feed is your visual portfolio. Luxury clients expect
            a sophisticated, cohesive aesthetic that reflects the caliber of
            weddings you create. Think Vogue, not generic wedding blog.
          </p>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            Generic captions like "Love this setup!" waste valuable real estate.
            Luxury clients want to understand your process, philosophy, and the
            thought behind your work.
          </p>
          ...
          <div className="bg-neutral-50 p-6 my-8 border-l-4 border-amber-600">
            <p className="text-base text-neutral-800 italic leading-relaxed">
              ...
              honor both the natural beauty and their sophisticated style. From
              hand-torn silk ribbons to vintage French chairs, we created an
              atmosphere that felt timeless yet utterly personal."
            </p>
          </div>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            Stories provide an opportunity to showcase your day-to-day expertise
            and build rapport with potential clients. Share behind-the-scenes
            planning moments, vendor collaborations, and expert tips.
          </p>
          ...
          <p className="text-lg text-neutral-700 leading-relaxed mb-6">
            Reels receive significantly higher reach than static posts. Use them
            strategically to demonstrate your expertise, showcase
          ...
          <div className="bg-amber-50 border-l-4 border-amber-600 p-8 my-12">
            ...
            <p className="text-lg text-neutral-800 leading-relaxed">
              Instagram is one of your most powerful tools for attracting luxury
              wedding clients—but only if you use it strategically. Invest time
              in creating a cohesive aesthetic, telling compelling stories, and
              engaging authentically with your audience. The results will speak
              for themselves.
            </p>
          </div>
          ...
          <div className="mt-16 pt-12 border-t border-neutral-200">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-8">
              ...
              engagement strategy, ensuring your Instagram reflects your premium
              brand.
            </p>
            <Link
              to="/contact"
