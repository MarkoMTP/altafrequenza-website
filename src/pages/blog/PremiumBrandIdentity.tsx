          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-3 mb-8 ml-6">
              <li className="text-lg text-neutral-700">
                ...
                planning weddings" is too broad. "High-net-worth couples
                planning sophisticated destination weddings" is precise.
              </li>
              <li className="text-lg text-neutral-700">
                <strong>What makes you different?</strong> Every successful
                luxury planner has a unique approach, aesthetic, or
                specialization. Identify yours.
              </li>
              <li className="text-lg text-neutral-700">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-6">
              Your visual brand should immediately communicate luxury. This
              means:
            </p>
            ...
            <ul className="space-y-3 mb-8 ml-6">
              <li className="text-lg text-neutral-700">
                ...
                fonts paired with clean sans-serifs. Avoid trendy or playful
                fonts that undermine premium positioning.
              </li>
              <li className="text-lg text-neutral-700">
              ...
              <li className="text-lg text-neutral-700">
                <strong>Professional photography:</strong> Invest in
                high-quality images of your work. Amateur iPhone shots don't
                belong on a luxury website.
              </li>
              <li className="text-lg text-neutral-700">
