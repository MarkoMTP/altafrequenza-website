    ...
    <>
      ...
      <div className="bg-luxury-champagne text-luxury-slate selection:bg-luxury-gold/30 pt-20 md:pt-24 min-h-screen font-light">
          ...
          <div className="max-w-7xl mx-auto relative z-10 text-center">
            ...
            >
              ...
              >
                ...
                <span className="min-w-0">Websites for Wedding Planners</span>
              </motion.div>
              ...
              <motion.div variants={fadeIn}>
                <Link
                  to="/contact"
                  className="group relative inline-flex w-full sm:w-auto max-w-full items-center justify-center gap-3 sm:gap-4 px-5 sm:px-12 py-4 sm:py-6 bg-luxury-slate text-white text-[9px] sm:text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.3em] font-bold md:hover:bg-luxury-gold md:hover:text-luxury-slate md:transition-all md:duration-700 rounded-full shadow-2xl overflow-hidden leading-relaxed text-center"
                >
                  ...
                  <ArrowRight
                    size={20}
                    className="relative z-10 flex-shrink-0 md:group-hover:translate-x-2 md:transition-transform md:duration-500"
                  />
        ...
        <section className="px-5 sm:px-6 lg:px-12 py-24 sm:py-28 lg:py-32 bg-white relative">
          ...
          <div className="space-y-20 sm:space-y-28 lg:space-y-32 max-w-6xl mx-auto">
            {/* Step 1 */}
            <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-20 items-center">
              <div className="order-2 lg:order-1">
                <div className="w-12 sm:w-16 h-12 sm:h-16 flex items-center justify-center bg-luxury-gold text-white rounded-full mb-6 sm:mb-8 shadow-xl">
                  <Layout size={24} className="sm:w-7 sm:h-7" />
                </div>
                <h3 className="text-2xl sm:text-3xl md:text-5xl font-serif text-luxury-slate mb-5 sm:mb-8 leading-tight">
                  1. A Modern Website Built for Luxury Positioning
                </h3>
                <p className="text-luxury-slate/60 text-base sm:text-lg mb-7 sm:mb-10 font-light leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 group">
                      <CheckCircle
                        size={18}
                        className="text-luxury-gold mt-1 md:group-hover:scale-110 md:transition-transform"
                      />
                      <span className="text-[12px] sm:text-sm font-bold uppercase tracking-[0.14em] sm:tracking-widest text-luxury-slate/60 md:group-hover:text-luxury-slate md:transition-colors leading-relaxed">
                        {item}
                      </span>
                    </div>
                  ))}
              ...
              <div className="order-1 lg:order-2 rounded-[2rem] sm:rounded-[3.5rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(15,23,42,0.15)] relative border border-luxury-gold/10 group aspect-[4/3]">
                <img
            ...
            {/* Step 2 */}
            <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-20 items-center">
              <div className="rounded-[2rem] sm:rounded-[3.5rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(15,23,42,0.15)] relative border border-luxury-gold/10 group aspect-[4/3]">
                <img
              ...
              <div>
                <div className="w-12 sm:w-16 h-12 sm:h-16 flex items-center justify-center bg-luxury-gold text-white rounded-full mb-6 sm:mb-8 shadow-xl">
                  <MousePointerClick size={24} className="sm:w-7 sm:h-7" />
                </div>
                <h3 className="text-2xl sm:text-3xl md:text-5xl font-serif text-luxury-slate mb-5 sm:mb-8 leading-tight">
        ...
        <section className="px-5 sm:px-6 lg:px-12 py-24 sm:py-28 lg:py-32 bg-luxury-slate text-white relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10 mb-12 sm:mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8 text-left">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group">
                  <div className="w-1.5 h-1.5 bg-luxury-gold rounded-full md:group-hover:scale-150 md:transition-transform" />
                  <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.14em] sm:tracking-[0.2em] text-white/50 md:group-hover:text-white md:transition-colors leading-relaxed">
                    {item}
                  </span>
                </div>
              ))}
        ...
        <section className="px-5 sm:px-6 lg:px-12 py-24 sm:py-28 lg:py-32 bg-luxury-slate text-white relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center mb-14 sm:mb-24 relative z-10">
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              className="text-base sm:text-xl text-white/40 max-w-4xl mx-auto font-light leading-relaxed italic"
            >
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            <div className="bg-white/5 backdrop-blur-3xl p-7 sm:p-12 lg:p-24 border border-white/10 rounded-[2rem] sm:rounded-[5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
              <div className="inline-flex max-w-full items-center gap-2 px-4 py-1.5 border border-luxury-gold/50 text-[9px] sm:text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.4em] font-bold text-luxury-gold mb-8 sm:mb-12 rounded-full leading-relaxed">
                <Award size={14} /> Architecture Excellence
              </div>

              <h3 className="text-2xl sm:text-3xl md:text-5xl font-serif text-white mb-6 sm:mb-10 tracking-tight leading-tight">
              ...
              <p className="text-white/40 text-base sm:text-lg mb-10 sm:mb-16 font-light leading-relaxed italic border-l border-luxury-gold/30 pl-5 sm:pl-8">
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-12 mb-10 sm:mb-20">
                <ul className="text-white/60 space-y-4 sm:space-y-6 text-[9px] sm:text-[10px] uppercase tracking-[0.14em] sm:tracking-[0.25em] font-bold">
                  {[
              ...
              <div className="flex flex-col items-center gap-6 sm:gap-8">
                <Link
                  to="/contact"
                  className="group relative inline-flex items-center justify-center gap-3 sm:gap-6 px-5 sm:px-16 py-5 sm:py-8 bg-white text-luxury-slate text-[9px] sm:text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.4em] font-bold rounded-full md:hover:bg-luxury-gold md:transition-all md:duration-700 w-full md:w-auto overflow-hidden leading-relaxed text-center"
                >
                  <span className="relative z-10 flex min-w-0 items-center gap-3 sm:gap-4">
                    Book a Short Call
                    <ArrowRight
                      size={20}
                      className="flex-shrink-0 md:group-hover:translate-x-2 md:transition-transform md:duration-700"
                    />
                  </span>
                  <div className="absolute inset-0 hidden bg-luxury-gold translate-y-full md:block md:group-hover:translate-y-0 md:transition-transform md:duration-700" />
                </Link>

                <p className="text-white/20 text-[9px] sm:text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.4em] font-bold text-center leading-relaxed">
