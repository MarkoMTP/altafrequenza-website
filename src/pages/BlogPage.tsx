...
export default function BlogPage({ onNavigate }: BlogPageProps) {
  const featuredPost = {
    title: 'The Psychology of Luxury Wedding Clients: What High-Net-Worth Couples Really Want',
    excerpt: 'Understanding the mindset of affluent couples is essential for wedding planners who want to position themselves as the premier choice. Here\'s what matters most to luxury clients.',
  ...
  const posts = [
    {
      ...
      excerpt: 'These common missteps can sabotage your efforts to attract high-end clientele. Learn what to avoid and what to do instead.',
    ...
    },
    {
      ...
      excerpt: 'Instagram is a goldmine for luxury wedding planners—if you use it correctly. Discover the strategies that top planners use.',
    ...
    },
    {
      ...
      excerpt: 'Most marketing agencies don\'t understand the luxury wedding industry. Here\'s why specialization matters.',
    ...
    },
    {
      ...
      excerpt: 'Discover how AI tools are transforming the way elite planners capture and qualify leads, saving time and increasing revenue.',
      category: 'Technology',
    ...
    },
    {
      ...
      excerpt: 'Your brand is your most valuable asset. Learn how to position yourself as a luxury service provider.',
      category: 'Branding',
    ...
    },
    {
      ...
      excerpt: 'Master Google Ads to consistently attract high-quality leads who are ready to invest in exceptional planning services.',
      ...
      <section className="py-24 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm tracking-widest text-neutral-500 mb-4">INSIGHTS & STRATEGIES</p>
            <h1 className="text-5xl md:text-7xl font-serif text-neutral-900 mb-6">
              The Alta Frequenza Journal
            </h1>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
              Expert insights on luxury wedding marketing, client psychology, and growing your planning business.
            </p>
          </div>
          ...
          <div className="mb-24">
            <article className="grid md:grid-cols-2 gap-12 items-center bg-neutral-50 border border-neutral-200 overflow-hidden">
              ...
              <div className="p-8 md:p-12">
                ...
                <p className="text-sm tracking-wide text-amber-600 mb-3">{featuredPost.category}</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post, index) => (
              <article key={index} className="group cursor-pointer" onClick={() => onNavigate('blog-' + post.slug)}>
                ...
                <p className="text-xs tracking-wide text-amber-600 mb-2">{post.category}</p>
                ...
                <button className="inline-flex items-center gap-2 text-sm text-neutral-900 group-hover:gap-3 transition-all">
      ...
      <section className="py-24 px-6 lg:px-12 bg-neutral-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-neutral-300 mb-10 leading-relaxed">
            Learn how Alta Frequenza Marketing can help you attract more luxury couples and grow your wedding planning business.
          </p>
          <button
