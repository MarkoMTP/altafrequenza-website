      ...
      <section className="min-h-[70vh] flex items-center justify-center px-6 lg:px-12 py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 leading-relaxed max-w-3xl mx-auto">
            We exist for one purpose: to help elite wedding planners attract and
            book the high-net-worth couples they deserve to work with.
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-neutral-700 leading-relaxed">
                ...
                <p>
                  ...
                  other service business. They run cookie-cutter campaigns that
                  attract tire-kickers and budget shoppers.
                </p>
                <p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-base md:text-lg text-neutral-700 leading-relaxed">
            ...
            <p>
              ...
              as refined as the celebrations they create, Marko founded Alta
              Frequenza Marketing.
            </p>
