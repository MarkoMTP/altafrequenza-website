...
export default function PlannerGrowthSystemPage() {
  ...
  const handleEmailSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.ok) {
        setStatus("Thanks. Check your email for the breakdown.");
        setEmail("");
      } else {
  ...
  const problems = [
    "Referrals are inconsistent and hard to plan around.",
    "Instagram visibility is not predictable enough to carry your season.",
    "Couples compare multiple planners before deciding who to contact.",
    "Many website visitors leave without sending a wedding request.",
    "Many requests are low-budget or not the right fit.",
    "It is often unclear which marketing activity is creating real opportunities.",
  ];
  ...
  const solutionSteps = [
    {
      ...
      description:
        "Google Search campaigns help you appear when couples are actively looking for a destination or luxury wedding planner.",
    },
    {
      icon: RefreshCcw,
      title: "Bring Warm Visitors Back",
      description:
        "Meta Ads and retargeting keep your brand in front of people who visited your website, engaged with your content, or are still comparing planners.",
    },
    {
      icon: MousePointerClick,
      title: "Improve the Path to Booking",
      description:
        "Tracking, wedding request flow recommendations, and lead-quality review help turn attention into stronger wedding requests, consultations, and booked weddings.",
    },
  ];
  ...
  const audiences = [
    {
      ...
      description:
        "For planners attracting international couples planning from abroad.",
    },
    {
      icon: Gem,
      title: "Luxury Wedding Planners",
      description:
        "For planners in competitive markets who want better wedding requests from couples ready to invest.",
    },
    {
      icon: MapPin,
      title: "High-End Regional Planners",
      description:
        "For planners who attract couples from outside their immediate area and need stronger visibility, trust, and follow-up.",
    },
  ];
  ...
  const pillars = [
    {
      icon: Users,
      title: "Built Around Wedding Buying Behaviour",
      description:
        "Couples do not always book immediately. They search, compare, revisit, and need trust before requesting a consultation.",
    },
    {
      icon: Target,
      title: "Focused on Wedding Requests, Not Vanity Metrics",
      description:
        "The goal is not followers, impressions, or random clicks. The goal is qualified wedding requests and booked weddings.",
    },
    {
      icon: ShieldCheck,
      title: "Designed for Season Stability",
      description:
        "The system is built to help planners create more consistent opportunities, so they can plan their season with more confidence.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="A growth system for destination and luxury wedding planners who want more qualified wedding requests and booked weddings through Google Search, Meta Ads, retargeting, and wedding request flow strategy."
        />
        <meta
          name="keywords"
          content="planner growth system, luxury wedding planner marketing, destination wedding planner marketing, qualified wedding requests, wedding planner Google Ads, wedding planner Meta Ads"
        />
        <meta
          property="og:title"
      ...
      <div className="bg-luxury-champagne text-luxury-slate selection:bg-luxury-gold/30 pt-20 sm:pt-24 min-h-screen">
          ...
          <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            ...
            >
              <div className="absolute inset-x-0 sm:inset-x-8 top-0 h-[280px] sm:h-[420px] rounded-[2rem] sm:rounded-[4rem] overflow-hidden border border-luxury-gold/10 shadow-2xl">
                <img
                  src="/destination-wedding-villa.jpeg"
              ...
              <div className="absolute left-0 bottom-0 w-32 h-44 sm:w-64 sm:h-80 rounded-[1.5rem] sm:rounded-[3rem] overflow-hidden border border-white/70 shadow-2xl bg-white p-1.5 sm:p-2">
                <img
                  src="/destination-wedding-couple.jpeg"
        ...
        {/* WHO THIS IS FOR */}
        <section className="py-16 sm:py-20 md:py-40 px-5 sm:px-6 lg:px-12 bg-luxury-champagne border-y border-luxury-gold/5">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[0.95fr_1.05fr] gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-7xl font-serif text-luxury-slate mb-10 tracking-tight leading-tight">
                Built for destination and luxury{" "}
                <span className="text-luxury-gold italic">
                  wedding planners.
                </span>
              </h2>
              ...
              <div className="space-y-5">
                {audiences.map((audience, index) => (
                  <motion.div
                    ...
                    className="grid grid-cols-[auto_1fr] gap-4 sm:gap-5 rounded-[1.5rem] sm:rounded-[2rem] bg-white p-5 sm:p-7 border border-luxury-gold/10 shadow-sm"
                  >
                    <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-luxury-slate text-white flex items-center justify-center shadow-xl">
                      <audience.icon size={21} />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-3xl font-serif text-luxury-slate mb-3 leading-tight">
                        {audience.title}
                      </h3>
                      <p className="text-luxury-slate/55 text-base font-light leading-relaxed">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative rounded-[2rem] md:rounded-[4rem] overflow-hidden shadow-2xl border border-luxury-gold/10 min-h-[430px] md:min-h-[560px]"
            >
              <img
                src="/destination-wedding-villa.jpeg"
                alt="Luxury wedding setting for destination planners"
                className="absolute inset-0 w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-luxury-slate/35" />
              <div className="absolute inset-x-4 bottom-4 sm:inset-x-10 sm:bottom-10 rounded-[1.5rem] sm:rounded-[2rem] bg-white/90 backdrop-blur-xl border border-white/60 p-5 sm:p-8">
                <p className="text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.24em] text-luxury-gold font-bold mb-4">
                  Fit check
                </p>

                <p className="text-base sm:text-xl text-luxury-slate/60 font-light leading-relaxed max-w-4xl mx-auto mb-5">
                  Built for destination and luxury wedding planners who want a
                  clearer way to attract serious couples, create more
                  predictable wedding requests, and book the kind of weddings
                  that fit their brand, budget, and vision.
                </p>
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-3 text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.24em] font-bold text-luxury-slate hover:text-luxury-gold transition-colors"
                >
                  Request analysis
                  <ArrowRight size={15} />
                </Link>
        ...
        {/* PROBLEM */}
        <section className="py-16 sm:py-20 md:py-36 px-5 sm:px-6 lg:px-12 bg-white">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 1 }}
              className="order-2 rounded-[2rem] md:rounded-[4rem] overflow-hidden shadow-2xl border border-luxury-gold/10 group"
            >
              <img
                src="/36.png"
                alt="Elegant destination wedding ceremony"
                className="w-full h-[320px] sm:h-[420px] md:h-[620px] object-cover group-hover:scale-105 transition-transform duration-1000"
              />
            </motion.div>
            <motion.div
              className="order-1"
            ...
            >
              <motion.p
                variants={fadeIn}
                className="text-[10px] uppercase tracking-[0.24em] sm:tracking-[0.4em] text-luxury-gold mb-10 font-bold"
              >
                The problem
              </motion.p>
              ...
              <motion.h2
                variants={fadeIn}
                className="text-3xl sm:text-4xl md:text-6xl font-serif text-luxury-slate mb-10 tracking-tight leading-tight"
              >
                Beautiful work does not automatically create{" "}
                <span className="text-luxury-gold italic">
                  booked weddings.
                </span>
              </motion.h2>
              ...
              <motion.div variants={fadeIn} className="space-y-5">
                {problems.map((item) => (
                  <div key={item} className="flex items-start gap-4">
                    ...
                    />
                    <p className="text-base sm:text-xl text-luxury-slate/60 font-light leading-relaxed">
                      {item}
                    </p>
                  </div>
                ))}
              ...
              >
                <Link
                  to="/contact"
                  className="group inline-flex items-center justify-center gap-3 px-5 sm:px-8 py-5 bg-luxury-slate text-white text-[10px] uppercase tracking-[0.12em] sm:tracking-[0.3em] font-bold rounded-[1.5rem] sm:rounded-full hover:bg-luxury-gold hover:text-luxury-slate transition-all duration-500 text-center"
                >
                  Review My Request Flow
                  <ArrowRight
                    size={16}
                ...
                <a
                  href="#packages"
                  className="inline-flex items-center justify-center px-5 sm:px-8 py-5 border border-luxury-gold/20 text-luxury-slate text-[10px] uppercase tracking-[0.12em] sm:tracking-[0.3em] font-bold rounded-[1.5rem] sm:rounded-full hover:bg-luxury-champagne transition-all duration-500 text-center"
                >
                  See Options
                </a>
              </motion.div>
        ...
        <section className="py-16 sm:py-20 md:py-36 px-5 sm:px-6 lg:px-12 bg-luxury-slate text-white overflow-hidden">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-20 items-start">
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-7xl font-serif mb-10 tracking-tight leading-tight">
                The hardest part is not slow months. It is not knowing{" "}
                <span className="text-luxury-gold italic">
                  where the next right wedding will come from.
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-white/50 font-light leading-relaxed mb-10">
                One year the season feels full. The next year, the right
                requests slow down, budgets feel weaker, and you are left hoping
                referrals, Instagram, or word of mouth will bring in the
                weddings you actually want.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/contact"
                  className="group inline-flex items-center justify-center gap-3 px-5 sm:px-8 py-5 bg-white text-luxury-slate text-[10px] uppercase tracking-[0.12em] sm:tracking-[0.3em] font-bold rounded-[1.5rem] sm:rounded-full hover:bg-luxury-gold transition-all duration-500 text-center"
                >
                ...
                <a
                  href="#packages"
                  className="inline-flex items-center justify-center px-5 sm:px-8 py-5 border border-white/15 text-white text-[10px] uppercase tracking-[0.12em] sm:tracking-[0.3em] font-bold rounded-[1.5rem] sm:rounded-full hover:border-luxury-gold hover:text-luxury-gold transition-all duration-500 text-center"
                >
                  Compare Packages
                </a>
              </div>
            ...
            <div className="space-y-5">
              {[
                "You get requests, but too many are not the budget, style, or type of wedding you actually want.",
                "Your season depends too much on referrals, past clients, Instagram, or unpredictable word of mouth.",
                "You can have a strong year, then suddenly feel unsure whether the next season will fill the same way.",
                "Couples look at your website or Instagram, but leave without sending a serious wedding request.",
                "You spend time replying to weak leads while the couples you really want may be choosing someone else.",
                "You cannot confidently plan growth because you do not know which marketing activity is creating real bookings.",
              ].map((item, index) => (
                <motion.div
                  key={item}
                  initial={{ opacity: 0, x: 30 }}
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.08 }}
                  className="group grid grid-cols-[2.5rem_1fr] sm:grid-cols-[auto_1fr] gap-4 sm:gap-6 border-b border-white/10 py-6 sm:py-8"
                >
                  <div className="text-3xl sm:text-5xl font-serif text-luxury-gold/70 group-hover:text-luxury-gold transition-colors">
                    0{index + 1}
                  </div>
                  <p className="text-base sm:text-2xl font-light leading-relaxed text-white/65 group-hover:text-white transition-colors">
                    {item}
                  </p>
                </motion.div>
              ))}
        ...
        <section className="py-16 sm:py-20 md:py-40 px-5 sm:px-6 lg:px-12 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-[0.85fr_1.15fr] gap-14 lg:gap-20 items-start mb-16">
              <div>
                <p className="text-[10px] uppercase tracking-[0.24em] sm:tracking-[0.4em] text-luxury-gold mb-10 font-bold">
                  The solution
                </p>
                ...
                <h2 className="text-3xl sm:text-4xl md:text-7xl font-serif text-luxury-slate mb-8 tracking-tight leading-tight">
                  A wedding request system built around how couples{" "}
                  <span className="text-luxury-gold italic">
                    actually choose a planner.
                  </span>
                </h2>
              </div>

              <p className="text-lg sm:text-xl text-luxury-slate/55 font-light leading-relaxed lg:pt-24">
                The system connects high-intent search, warm follow-up, and the
                path from first visit to consultation, so attention has a
                clearer route toward qualified wedding requests and booked
                weddings.
              </p>
            </div>

            <div className="space-y-8">
              {solutionSteps.map((part, index) => (
                <motion.div
                  key={part.title}
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.08 }}
                  className="grid lg:grid-cols-[auto_0.85fr_1fr] gap-5 sm:gap-6 lg:gap-10 items-center rounded-[1.75rem] sm:rounded-[2.5rem] border border-luxury-gold/10 bg-luxury-champagne/20 p-5 sm:p-8 lg:p-10"
                >
                  <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-luxury-slate text-white flex items-center justify-center shadow-xl">
                    <part.icon size={25} />
                  </div>
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.28em] text-luxury-gold font-bold mb-4">
                      Step 0{index + 1}
                    </p>
                    <h3 className="text-2xl sm:text-4xl font-serif text-luxury-slate leading-tight">
                      {part.title}
                    </h3>
                  </div>
                  <p className="text-luxury-slate/55 text-base sm:text-lg font-light leading-relaxed">
                    {part.description}
                  </p>
                </motion.div>
              ))}
            ...
            <div className="mt-12 flex justify-center">
              ...
              >
                Build Your Wedding Request System
                <ArrowRight
                  size={17}
            ...
            <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-12 lg:gap-16 items-start">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl md:text-7xl font-serif mb-8 tracking-tight leading-tight">
                  The goal is simple:{" "}
                  <span className="text-luxury-gold italic">
                    more of the weddings you actually want.
                  </span>
                </h2>
              ...
              >
                ...
                <p className="text-lg sm:text-xl text-white/45 mb-10 font-light leading-relaxed">
                  Receive the full breakdown of how we helped a luxury wedding
                  planner generate consistent wedding requests, attract
                  better-fit couples, and fill her season more calmly.
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 md:mb-20">
              ...
              <p className="text-lg sm:text-xl text-luxury-slate/55 max-w-4xl mx-auto font-light leading-relaxed">
                Both packages are built for planners who want more serious
                wedding requests and better booking opportunities. The
                difference is how many channels we use to reach, re-engage, and
                convert those couples.
              </p>
              ...
              {[
                {
                  ...
                  description:
                    "A focused Google Search system for planners who want to capture couples already looking for a wedding planner.",
                  value:
                    "This gives you the foundation: visibility in front of high-intent couples, a dedicated landing page, and a lead magnet to help turn paid traffic into real wedding requests.",
                  includes: [
                    ...
                    "Campaign-specific landing page included",
                  ...
                  assets: [
                    {
                      title: "Landing Page",
                      text: "A focused page built around one goal: turning campaign traffic into serious wedding requests.",
                    },
                    {
                      title: "Lead Magnet",
                      text: "A useful guide or resource couples can request before they are ready to book a consultation.",
                    },
                  ],
                  difference: [
                    "Best when you want to start lean.",
                    "Focused only on people already searching.",
                    "Strong first step before adding more channels.",
                  ],
                ...
                },
                {
                  ...
                  price: "€1,120 setup + €990/month",
                  description:
                    "A fuller system for planners who want to capture demand on Google and bring warm couples back through Meta and retargeting.",
                  value:
                    "This gives you more ways to win the same couple: you appear when they search, follow up when they compare, and stay visible while they decide who to contact.",
                  includes: [
                    "Everything in Search Foundation, plus:",
                    ...
                    "Audience and creative testing to improve performance",
                    "Conversion tracking setup/check for Meta Ads",
                    "Monthly pipeline and lead-quality review",
                  ],
                  assets: [
                    {
                      title: "Meta Ads",
                      text: "Used to build trust, stay visible, and re-engage couples who are still comparing planners.",
                    },
                    {
                      title: "Retargeting",
                      text: "Brings back warm website visitors and social engagers before they forget you or choose another planner.",
                    },
                  ],
                  difference: [
                    "More touchpoints before couples decide.",
                    "Stronger for longer buying cycles.",
                    "Better for planners who have bigger budgets.",
                  ],
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p
                      className={`text-base sm:text-lg font-light leading-relaxed mb-5 ${
                        offer.featured
                          ? "text-white/60"
                    ...
                    <div
                      className={`rounded-2xl p-5 border mb-8 ${
                        offer.featured
                          ? "border-white/10 bg-white/5"
                          : "border-luxury-gold/10 bg-luxury-champagne/30"
                      }`}
                    >
                      <p className="text-[10px] uppercase tracking-[0.22em] text-luxury-gold font-bold mb-3">
                        What this gives you
                      </p>
                      <p
                    ...
                    <div
                      className={`rounded-2xl p-5 border mb-8 ${
                        offer.featured
                          ? "border-luxury-gold/20 bg-luxury-gold/10"
                          : "border-luxury-gold/10 bg-luxury-champagne/30"
                      }`}
                    >
                      <p className="text-[10px] uppercase tracking-[0.22em] text-luxury-gold font-bold mb-4">
                        Why choose this
                      </p>
                      <div className="space-y-3">
                        {offer.difference.map((item) => (
                          <div key={item} className="flex items-start gap-3">
                            <CheckCircle
                              size={16}
                              className="text-luxury-gold mt-1 flex-shrink-0"
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-20 items-start">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-7xl font-serif text-luxury-slate mb-8 tracking-tight leading-tight">
                ...
                <span className="text-luxury-gold italic">
                  Wedding-specific growth systems.
                </span>
              </h2>

              <p className="text-lg text-luxury-slate/55 font-light leading-relaxed mb-10">
                The strategy is built around how serious couples actually move:
                search, compare, revisit, trust, request a consultation, and
                decide.
              </p>
            ...
            <div className="space-y-6">
              {pillars.map((pillar, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="grid sm:grid-cols-[auto_1fr] gap-5 sm:gap-8 p-6 sm:p-9 rounded-[1.75rem] sm:rounded-[2.5rem] border border-luxury-gold/10 bg-luxury-champagne/30 shadow-sm"
                >
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-luxury-slate text-white flex items-center justify-center shadow-xl">
                    <pillar.icon size={24} />
                  </div>
                  <div>
                    <div className="text-luxury-gold font-bold text-[10px] uppercase tracking-[0.18em] sm:tracking-[0.3em] mb-5">
                      Pillar 0{index + 1}
                    </div>
                    <h3 className="text-lg sm:text-2xl font-bold uppercase tracking-[0.12em] sm:tracking-widest text-luxury-slate mb-5 leading-relaxed">
                      {pillar.title}
                    </h3>
                    <p className="text-luxury-slate/50 font-light leading-relaxed text-sm sm:text-base">
                      {pillar.description}
                    </p>
                  </div>
                </motion.div>
