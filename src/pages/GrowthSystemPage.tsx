      ...
      <section className="min-h-[70vh] flex items-center justify-center px-6 lg:px-12 py-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-600 leading-relaxed max-w-3xl mx-auto mb-12">
            Precision-targeted Google Ads campaigns designed exclusively for
            luxury wedding planners. We position you in front of high-net-worth
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Most campaigns cast too wide a net, attracting budget-conscious
                couples who can't afford premium services.
              </p>
            </div>
            ...
            <div className="bg-white p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Clicks are expensive. Generic landing pages fail to convert
                luxury-minded couples into qualified leads.
              </p>
            </div>
            ...
            <div className="bg-white p-8 border border-neutral-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                Ad copy that doesn't speak to affluent couples results in clicks
                from the wrong audience—wasting your budget.
              </p>
            </div>
          </div>
          ...
          <div className="bg-neutral-900 text-white p-12 text-center">
            <h3 className="text-3xl font-serif mb-4">
              The Alta Frequenza Difference
            </h3>
            <p className="text-xl text-neutral-300 leading-relaxed max-w-3xl mx-auto">
              We've spent years perfecting Google Ads strategies specifically
              for luxury wedding planners. Our campaigns are engineered to
              attract only high-net-worth couples who value exceptional service.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                  We don't target generic wedding planning searches. Our
                  campaigns focus exclusively on high-intent, luxury-specific
                  keywords that affluent couples actually use.
                </p>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    />
                    <span className="text-neutral-700">
                      "High-end destination wedding coordinator"
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    />
                    <span className="text-neutral-700">
                      "Full-service luxury wedding planner"
                    </span>
                  </li>
                </ul>
              </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700 mb-2">
                        www.yoursite.com/luxury-planning
                      </p>
                      <p className="text-sm text-neutral-700 leading-relaxed">
                        Discerning couples trust us to orchestrate flawless
                        luxury weddings. Full-service planning for sophisticated
                        celebrations.
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4">
                  <div className="bg-white p-6 border-l-4 border-amber-600">
                    ...
                    <p className="text-sm text-neutral-700">
                      Sophisticated design that reflects luxury brand standards
                    </p>
                  </div>
                  <div className="bg-white p-6 border-l-4 border-amber-600">
                    <h4 className="font-medium text-neutral-900 mb-2">
                    ...
                    <p className="text-sm text-neutral-700">
                      Testimonials, portfolio highlights, and social proof
                    </p>
                  </div>
                  <div className="bg-white p-6 border-l-4 border-amber-600">
                    <h4 className="font-medium text-neutral-900 mb-2">
                    ...
                    <p className="text-sm text-neutral-700">
                      Immediate clarity on your unique approach and expertise
                    </p>
                  </div>
                  <div className="bg-white p-6 border-l-4 border-amber-600">
                    <h4 className="font-medium text-neutral-900 mb-2">
                    ...
                    <p className="text-sm text-neutral-700">
                      Strategic CTAs that guide couples to book consultations
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                  Every click is an investment. We design custom landing pages
                  that convert luxury-minded couples into qualified consultation
                  requests. No generic templates—only premium experiences.
                </p>
                <p className="text-neutral-700 leading-relaxed">
                  Our landing pages are built with sophisticated design,
                  compelling copy, and strategic calls-to-action that resonate
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                  We don't set and forget. Our team constantly monitors campaign
                  performance, refines targeting, tests ad variations, and
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Deep analysis of your ideal luxury client demographics,
                behaviors, and search patterns.
              </p>
            </div>
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Luxury-specific keyword research and selection tailored to your
                market and services.
              </p>
            </div>
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Sophisticated ad messaging that resonates with affluent couples
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Conversion-optimized landing pages with premium design and
                strategic CTAs.
              </p>
            </div>
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Comprehensive analytics setup and tracking to measure every
                aspect of campaign success.
              </p>
            </div>
            ...
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300 leading-relaxed">
                Continuous campaign refinement, A/B testing, and strategic
                improvements.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
              We're so confident in our system that we only succeed when you do.
              No monthly retainers, no hidden fees—just results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-neutral-50 p-10 border border-neutral-200">
              ...
              <p className="text-lg text-neutral-700 leading-relaxed mb-8">
                Your initial setup fee covers everything needed to launch a
                world-class Google Ads campaign designed specifically for your
                business.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-600">
                      Premium, conversion-optimized page built for your brand
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-600">
                      Deep research into your market, competitors, and
                      opportunities
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-medium text-neutral-900">
                      Full Google Ads Setup
                    </div>
                    <p className="text-sm text-neutral-600">
                      Campaign structure, keyword research, ad copy, and
                      tracking
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-600">
                      Comprehensive tracking to measure every result
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-neutral-900 text-white p-10">
              <div className="text-5xl font-serif text-amber-600 mb-4">15%</div>
              <h3 className="text-2xl font-medium mb-6">
                Success Fee per Wedding Booked
              </h3>
              <p className="text-lg text-neutral-300 leading-relaxed mb-8">
                We only earn when you book weddings through our system. No
                monthly retainers. No management fees. Just a simple
                success-based model that aligns our interests with yours.
              </p>
              ...
              <div className="bg-neutral-800 p-6 border border-neutral-700 mb-6">
                ...
                <ol className="space-y-3 text-neutral-300">
                  <li className="flex gap-3">
                    <span className="text-amber-600 font-serif flex-shrink-0">
                      1.
                    </span>
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      We receive 15% of your planning fee as our success fee
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-amber-600/10 border border-amber-600/30 p-6">
                <p className="text-neutral-200 leading-relaxed">
                  <span className="font-medium text-white">Example:</span> If
                  you earn a $10,000 wedding fee from a lead we generated, we
                  earn $1,500. If you don't book any weddings, you pay nothing
          ...
          <div className="bg-amber-50 border-l-4 border-amber-600 p-8 mb-12">
            ...
            <p className="text-lg text-neutral-800 leading-relaxed mb-4">
              Traditional agencies charge $3,000-$8,000 per month whether or not
              you get results. We're different. We're confident enough in our
              system that we tie our revenue directly to your success.
            </p>
            <p className="text-lg text-neutral-800 leading-relaxed">
              This means we're highly motivated to optimize every aspect of your
              campaign, ensure lead quality is exceptional, and continuously
              improve performance. Your success is literally our success.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-neutral-700 mb-8 max-w-2xl mx-auto leading-relaxed">
              Schedule a strategy session to learn more about our
