      ...
      <section className="min-h-[80vh] flex items-center justify-center px-6 lg:px-12 py-24 bg-gradient-to-b from-amber-50 to-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-neutral-700 leading-relaxed max-w-3xl mx-auto mb-10">
            ...
            who want a steady stream of qualified international couples — ready
            to book weddings in the{" "}
      ...
      <section className="py-24 px-6 lg:px-12 bg-neutral-900 text-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-neutral-300 leading-relaxed max-w-3xl mx-auto mb-16">
            Most planners try Google Ads once, get clicks from couples with €15K
            budgets, and decide “ads don’t work.” The truth? You just targeted
            the wrong people. The Growth System™ is designed for{" "}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              ...
              <p className="text-neutral-300">
                Standard keywords bring in everyone — including couples looking
                for planners under €10K.
              </p>
            </div>
            <div className="bg-neutral-800 p-8 border border-neutral-700">
              <h3 className="text-xl font-semibold mb-3 text-amber-500">
            ...
            <div className="bg-neutral-50 p-8 border border-neutral-200">
              ...
              <div className="mt-6 p-6 bg-white border border-neutral-300">
                <p className="text-sm italic text-neutral-600">
                  “Marko helped us generate consistent leads every month — real
                  couples who booked weddings through our campaigns.”
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-lg text-neutral-700 leading-relaxed">
                Every click is a potential €100K+ wedding — we make sure none go
                to waste.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-neutral-700">
                You’ll receive a clean monthly video breakdown with insights and
                next steps — no technical jargon, just clarity.
              </p>
            </div>
            ...
            <div className="bg-neutral-900 text-white p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-3xl font-serif text-amber-600">5</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-300">Avg. Wedding Budget</span>
                  <span className="text-3xl font-serif text-amber-600">
                    €200K+
                  </span>
                </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-neutral-800 p-10 border border-neutral-700 text-left">
            ...
            <p className="text-neutral-300 mb-6">
              Generate qualified inquiries from high-spending couples searching
              for wedding planners in Italy, France, and beyond.
            </p>
      ...
      <section className="py-24 px-6 lg:px-12 text-center bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-neutral-700 mb-10 leading-relaxed">
            ...
            System™ can turn your expertise into consistent, high-quality leads
            every single month.
          </p>
          <Link
            to="/contact"
